...
/**
 * Test for transaction MMFTT00101MXTransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/MMFTT00101MXTest.xml" })
public class MMFTT00101MXTransactionTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(MMFTT00101MXTransactionTest.class);

	@Autowired
	private MMFTT00101MXTransaction transaction;
